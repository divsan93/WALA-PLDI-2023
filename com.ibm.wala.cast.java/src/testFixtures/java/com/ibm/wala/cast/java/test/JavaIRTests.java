...
public abstract class JavaIRTests extends IRTests {
  ...
  public JavaIRTests() {
    ...
    @Test
    public void testTestQuery() throws CallGraphBuilderCancelException, IOException {
        Collection path  = Collections.singletonList(getTestSrcPath() + File.separator + "TestSelectQuery.java");
        String[] str = simpleTestEntryPoint();
        List<? extends IRAssertion> assertions =
                Arrays.asList();
        AbstractAnalysisEngine<InstanceKey, CallGraphBuilder<InstanceKey>, ?> engine =
                getAnalysisEngine(str, path, rtJar);
        ...
        //if (dump) {
        //    dumpIR(callGraph, path, true);
        //}

    }

  @Test
  public void testJTA() throws CallGraphBuilderCancelException, IOException {
        Collection path  = Collections.singletonList(getTestSrcPath() + File.separator + "JTA.java");
        String[] str = simpleTestEntryPoint();
        List<? extends IRAssertion> assertions =
                Arrays.asList();
        AbstractAnalysisEngine<InstanceKey, CallGraphBuilder<InstanceKey>, ?> engine =
    ...
    @Test
    public void testSimple11() throws CallGraphBuilderCancelException, IOException {
        Collection path  = Collections.singletonList(getTestSrcPath() + File.separator + "TestSelectQuery.java");
        String[] str = simpleTestEntryPoint();
        List<? extends IRAssertion> assertions =
                Arrays.asList();
    ...
    @Test
    public void testAirlineProblem() throws CallGraphBuilderCancelException, IOException {
        Collection path  = Collections.singletonList(getTestSrcPath() + File.separator + "AirlineProblem.java");
        String[] str = simpleTestEntryPoint();
        List<? extends IRAssertion> assertions =
                Arrays.asList();
        AbstractAnalysisEngine<InstanceKey, CallGraphBuilder<InstanceKey>, ?> engine =
    ...
    @Test
    public void testCoffeesTable() throws CallGraphBuilderCancelException, IOException {
        Collection path  = Collections.singletonList(getTestSrcPath() + File.separator + "CoffeesTable.java");
        String[] str = simpleTestEntryPoint();
        List<? extends IRAssertion> assertions =
                Arrays.asList();
        AbstractAnalysisEngine<InstanceKey, CallGraphBuilder<InstanceKey>, ?> engine =
    ...
    @Test
    public void testTest() throws CallGraphBuilderCancelException, IOException {
        Collection path  = Collections.singletonList(getTestSrcPath() + File.separator + "Test.java");
        String[] str = simpleTestEntryPoint();
        List<? extends IRAssertion> assertions =
                Arrays.asList();
        AbstractAnalysisEngine<InstanceKey, CallGraphBuilder<InstanceKey>, ?> engine =
  ...
  @Test
  public void testSimple111() throws IllegalArgumentException, CancelException, IOException {
