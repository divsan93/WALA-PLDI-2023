...
public class CAstOperator implements CAstLeafNode {
  ...
  public static final CAstOperator OP_LIKE = new CAstOperator("like");

  public static final CAstOperator OP_NOT_LIKE = new CAstOperator("not like");
  public static final CAstOperator OP_REL_BETWEEN = new CAstOperator("between");

  public static final CAstOperator OP_LG = new CAstOperator("<>");
}
