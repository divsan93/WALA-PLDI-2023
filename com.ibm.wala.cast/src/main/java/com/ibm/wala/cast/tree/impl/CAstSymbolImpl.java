...
public class CAstSymbolImpl extends CAstSymbolImplBase {
  ...
  public CAstSymbolImpl(String _name, CAstType type, boolean _isFinal, Object _defaultInitValue) {
    super(_name, type, _isFinal, _defaultInitValue,-1);
  }
  public CAstSymbolImpl(String _name, CAstType type, boolean _isFinal, Object _defaultInitValue, int length) {
    super(_name, type, _isFinal, _defaultInitValue,length);
  }
