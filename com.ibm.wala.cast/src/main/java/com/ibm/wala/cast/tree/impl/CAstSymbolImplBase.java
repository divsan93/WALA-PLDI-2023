...
public abstract class CAstSymbolImplBase implements CAstSymbol {
  ...
  public CAstSymbolImplBase(String name, CAstType type, boolean isFinal, Object defaultInitValue, int length) {
    this(name, type, isFinal, false, defaultInitValue, length);
  }
  ...
  public CAstSymbolImplBase(String name, CAstType type, boolean isFinal, boolean isCaseSensitive) {
    this(name, type, isFinal, isCaseSensitive, null, -1);
  }
  ...
  public CAstSymbolImplBase(String name, CAstType type, boolean isFinal, Object defaultInitValue) {
    this(name, type, isFinal, false, defaultInitValue,-1);
  }
