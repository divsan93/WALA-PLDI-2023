...
public final class TypeReference implements Serializable {
  ...
  public static final TypeName HexName = TypeName.string2TypeName("H");

  public static final byte HexTypeCode = 'H';

  public static final TypeReference Hex = makePrimitive(HexName);
