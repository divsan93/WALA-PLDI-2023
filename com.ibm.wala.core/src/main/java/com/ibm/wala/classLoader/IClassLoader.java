...
public interface IClassLoader {
   ...
   */
  public abstract Reader getSource(IMethod method, int offset) throws IOException;
   ...
   *     recorded. SJF .. we should think about this deprecation. postponing deprecation for now.
   */
  public abstract Reader getSource(IClass klass) throws NoSuchElementException, IOException;
